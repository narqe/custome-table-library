...
var DragNDropIcon = _interopDefault(require('@material-ui/icons/DragIndicator'));
...
var KeyboardArrowUpIcon = _interopDefault(require('@material-ui/icons/KeyboardArrowUp'));
    ...
    value: function translate(keys, options, lastKey) {
      ...
      if (handleAsObjectInI18nFormat && res && handleAsObject && noObject.indexOf(resType) < 0 && !(typeof joinArrays === 'string' && resType === '[object Array]')) {
        ...
        if (usedKey || usedDefault || updateMissing) {
          ...
          if (keySeparator) {
            var fk = this.resolve(key, _objectSpread$2({}, options, {
              keySeparator: false
            }));
  ...
  _createClass$1(Connector, [{
    ...
    value: function saveMissing(languages, namespace, key, fallbackValue, isUpdate) {
      ...
      if (this.backend && this.backend.create) {
        this.backend.create(languages, namespace, key, fallbackValue, null, _objectSpread$2({}, options, {
          isUpdate: isUpdate
        }));
      }
...
var activeLabel = "Activo";
var inactiveLabel = "Inactivo";
var disabledLabel = "Inhabilitado";
var nameLabel = "Nombre";
var fullNameLabel = "Apellido y nombre";
var actionsLabel = "Acciones";
var stateLabel = "Estado";
var priceLabel = "Precio";
var conditionLabel = "Condición";
var newLabel = "Nuevo";
var usedLabel = "Usado";
...
var idLabel = "Id";
var statusLabel = "Estado";
var totalLabel = "Total";
var acceptLabel = "Aceptar";
var backLabel = "Volver";
var reloadLabel = "Recargar";
var loginLabel = "Ingresar";
var descriptionLabel = "Descripción";
var synchronize = "Sincronizar";
var rowsPerPageLabel = "Resultados por página: ";
var ofLabel = "de";
var TRANSLATIONS_ES = {
...
function _setPrototypeOf$1(o, p) {
  _setPrototypeOf$1 = setPrototypeOf$1 || function _setPrototypeOf(o, p) {
    o.__proto__ = p;
    return o;
  };
  ...
  return function wrapWithConnect(WrappedComponent) {
    ...
    function ConnectFunction(props) {
      ...
      var ContextToUse = React.useMemo(function () {
        ...
        return propsContext && propsContext.Consumer && reactIs.isContextConsumer( /*#__PURE__*/React__default.createElement(propsContext.Consumer, null)) ? propsContext : Context;
      ...
      var renderedWrappedComponent = React.useMemo(function () {
        return /*#__PURE__*/React__default.createElement(WrappedComponent, _extends$2({}, actualChildProps, {
    ...
    if (forwardRef) {
      var forwarded = React__default.forwardRef(function forwardConnectRef(props, ref) {
        return /*#__PURE__*/React__default.createElement(Connect, _extends$2({}, props, {
...
function useKeyboardSensor(api) {
  var unbindEventsRef = React.useRef(noop$1$1);
  var startCaptureBinding = useMemo(function () {
    return {
      eventName: 'keydown',
...
var isVisible$1 = isEqual$1$1('visible');
...
function useValidation$1(props, contextId, getRef) {
  useDevSetupWarning(function () {
    ...
    !isInteger$1(props.index) ? process.env.NODE_ENV !== "production" ? invariant$1(false, prefix(id) + " requires an integer index prop") : invariant$1(false) : void 0;
...
var ReorderItems = function ReorderItems(list, startIndex, endIndex) {
...
var EnhancedTableToolbar = function EnhancedTableToolbar(props) {
  ...
  var title = props.title,
      ...
      massiveActions = props.massiveActions,
      massiveActionOnSelect = props.massiveActionOnSelect,
      onDragNDropCancel = props.onDragNDropCancel,
      onDragNDropConfirm = props.onDragNDropConfirm,
      massiveActionOnSelectClick = props.massiveActionOnSelectClick,
      hasChanged = props.hasChanged,
      selectedOptions = props.selectedOptions;

  var handleMassiveClick = function handleMassiveClick(selected) {
    return function () {
      return massiveActionOnSelectClick(selected);
    };
  };
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    ...
    variant: "subtitle1",
    component: "div"
  }, subtitle)), /*#__PURE__*/React__default.createElement("div", null, numSelected > 0 && !!massiveActionOnSelect && massiveActionOnSelect.map(function (btn, index) {
    return /*#__PURE__*/React__default.createElement(Tooltip, {
      key: index,
      title: t(btn.description)
  ...
  }), !!massiveActions && massiveActions.map(function (action, i) {
    return /*#__PURE__*/React__default.createElement(Tooltip, {
  ...
  }), !!hasChanged && /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(Tooltip, {
    title: t('cancel')
  }, /*#__PURE__*/React__default.createElement(core.Button, {
    variant: "outlined",
    color: "primary",
  ...
  }, t('cancel'))), /*#__PURE__*/React__default.createElement(Tooltip, {
    title: t('save')
  }, /*#__PURE__*/React__default.createElement(core.Button, {
    variant: "contained",
    color: "primary",
...
var Paginator = function Paginator(props) {
  var onChangePage = props.onChangePage,
      onChangeSizePage = props.onChangeSizePage,
      pageNo = props.pageNo,
      pageSize = props.pageSize,
      totalPages = props.totalPages,
      resultsPerPage = props.resultsPerPage;

  var _useState = React.useState(pageNo),
      page = _useState[0],
      setPage = _useState[1];

  var _useState2 = React.useState(pageSize),
  ...
  return /*#__PURE__*/React__default.createElement(TablePagination, {
    classes: classes,
    ...
    labelDisplayedRows: function labelDisplayedRows(_ref) {
      var from = _ref.from,
          to = _ref.to,
          count = _ref.count;
      return from + "-" + to + " " + t('ofLabel') + " " + (count !== -1 ? count : t('moreThanLabel') + " " + to);
    }
  });
};
...
var RESET_FORM = 'Selected/RESET_FORM';
var UPDATE_IDS_SELECTED = 'Selected/UPDATE_IDS_SELECTED';
var resetSelected = function resetSelected(payload) {
  return {
    type: RESET_FORM,
    payload: payload
  };
};
var updateSelected = function updateSelected(payload, rows) {
  return {
...
var SelectedReducer = function SelectedReducer(state, action) {
  if (state === void 0) {
    state = INITIAL_STATE;
  }
...
var SimpleCheckableTable = function SimpleCheckableTable(_ref) {
  var title = _ref.title,
      subtitle = _ref.subtitle,
      massiveActions = _ref.massiveActions,
      ...
      frontPagination = _ref.frontPagination,
      onChangePage = _ref.onChangePage,
      onChangeSizePage = _ref.onChangeSizePage,
      actionsButtons = _ref.actionsButtons,
      ActionComponent = _ref.actionsByRow,
      massiveActionOnSelect = _ref.massiveActionOnSelect,
      massiveActionOnSelectClick = _ref.massiveActionOnSelectClick,
      isDragNDrop = _ref.isDragNDrop,
      _ref$onDragNDrop = _ref.onDragNDrop,
      onDragNDrop = _ref$onDragNDrop === void 0 ? function () {} : _ref$onDragNDrop,
      _ref$onDragNDropCance = _ref.onDragNDropCancel,
      onDragNDropCancel = _ref$onDragNDropCance === void 0 ? function () {} : _ref$onDragNDropCance,
      _ref$onDragNDropConfi = _ref.onDragNDropConfirm,
      onDragNDropConfirm = _ref$onDragNDropConfi === void 0 ? function () {} : _ref$onDragNDropConfi;

  var _useTranslation = useTranslation(),
      t = _useTranslation.t;

  var _useReducer = React.useReducer(SelectedReducer, INITIAL_STATE),
  ...
  var _useState3 = React.useState(false),
      changed = _useState3[0],
      setChanged = _useState3[1];

  var EnhancedTableHead = function EnhancedTableHead(props) {
    var onSelectAllClick = props.onSelectAllClick,
        numSelected = props.numSelected,
        rowCount = props.rowCount;
    return /*#__PURE__*/React__default.createElement(TableHead, null, /*#__PURE__*/React__default.createElement(TableRow, null, !!isDragNDrop && /*#__PURE__*/React__default.createElement(TableCell, {
    ...
    })), columnsData.map(function (_ref2, indexCol) {
      var headerName = _ref2.headerName;
      return /*#__PURE__*/React__default.createElement(TableCell, {
        key: indexCol
      }, t(headerName));
    }), !!actionsButtons && /*#__PURE__*/React__default.createElement(TableCell, {
      align: "center"
    }, t('actionsLabel'))));
  };

  var handleSelectAllClick = function handleSelectAllClick(event, data) {
    if (event.target.checked) {
      var newSelecteds = data.map(function (n) {
        return n.id ? n.id : n[Object.keys(n)[0]];
      });
      var newSelectedsArray = data;
  ...
  var handleClick = function handleClick(event, row) {
    var selectedIndex = selected.idsSelected.indexOf(row.id ? row.id : row[Object.keys(row)[0]]);
    var selectedIndexArray = selected.rowsSelected.indexOf(row);
    var newSelected = [];
    var arraySelected = [];

    if (selectedIndex === -1) {
      newSelected = newSelected.concat(selected.idsSelected, row.id ? row.id : row[Object.keys(row)[0]]);
      ...
      newSelected = newSelected.concat(selected.idsSelected.slice(0, selectedIndex), selected.idsSelected.slice(selectedIndex + 1));
      arraySelected = arraySelected.concat(selected.rowsSelected.slice(0, selectedIndexArray), selected.rowsSelected.slice(selectedIndexArray + 1));
    }
  ...
  var isSelected = function isSelected(id) {
    return selected.idsSelected.indexOf(id) !== -1;
  };

  var onDragEnd = function onDragEnd(_ref3) {
    var source = _ref3.source,
        destination = _ref3.destination;
    var newTableRows = ReorderItems(rowsData, source.index, destination.index);
    onDragNDrop(newTableRows);
    setChanged(true);
  };

  if (!!isLoading) {
    return /*#__PURE__*/React__default.createElement(TableLoading, null);
  }

  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(EnhancedTableToolbar, {
    title: title,
    subtitle: subtitle,
  ...
  }), /*#__PURE__*/React__default.createElement(TableContainer, null, /*#__PURE__*/React__default.createElement(DragDropContext, {
    onDragEnd: onDragEnd
    ...
    onSelectAllClick: function onSelectAllClick(e) {
      return handleSelectAllClick(e, rowsData);
    },
    rowCount: rowsData.length
  }), /*#__PURE__*/React__default.createElement(ConnectedDroppable, {
    droppableId: "custom-table-body-id"
  }, function (provided) {
    return /*#__PURE__*/React__default.createElement(TableBody, _extends({}, provided.droppableProps, {
      ref: provided.innerRef
    }), !!frontPagination ? rowsData.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage) : rowsData.map(function (row, indexRow) {
      var isItemSelected = isSelected(row.id ? row.id : row[Object.keys(row)[0]]);
      var labelId = "enhanced-table-checkbox-" + indexRow;
      return /*#__PURE__*/React__default.createElement(PublicDraggable, {
        ...
        return /*#__PURE__*/React__default.createElement(TableRow, _extends({
        ...
        }), !!isDragNDrop && /*#__PURE__*/React__default.createElement(TableCell, {
          className: "CustomTable__Cell__DraggingIndicator",
          align: "center"
        }, /*#__PURE__*/React__default.createElement(DragNDropIcon, null)), /*#__PURE__*/React__default.createElement(TableCell, {
          padding: "checkbox",
        ...
        })), columnsData.map(function (_ref4) {
          var label = _ref4.label,
              _ref4$valueFixed = _ref4.valueFixed,
              valueFixed = _ref4$valueFixed === void 0 ? null : _ref4$valueFixed,
              _ref4$translationsLab = _ref4.translationsLabel,
              translationsLabel = _ref4$translationsLab === void 0 ? null : _ref4$translationsLab;
          var translation = !!translationsLabel ? t(translationsLabel["" + row[label]]) : '';
          return /*#__PURE__*/React__default.createElement(TableCell, {
          ...
          align: "center"
        }, /*#__PURE__*/React__default.createElement(ActionComponent, {
          row: row,
          indexRow: indexRow
        })));
      });
    }), provided.placeholder);
  })))), /*#__PURE__*/React__default.createElement(Paginator, {
...
SimpleCheckableTable.propTypes = {
  actionsByRow: propTypes.actionsButtons === true ? propTypes.func.isRequired : propTypes.func
};
SimpleCheckableTable.defaultProps = {
  actionsByRow: function actionsByRow() {}
};

var CollapsibleTable = function CollapsibleTable(_ref) {
  var title = _ref.title,
      subtitle = _ref.subtitle,
      massiveActions = _ref.massiveActions,
      rowsData = _ref.rowsData,
      ...
      actionsButtons = _ref.actionsButtons,
      ActionComponent = _ref.actionsByRow,
      CollapsibleComponent = _ref.collapsibleComponent;
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(TableContainer, null, /*#__PURE__*/React__default.createElement(EnhancedTableToolbar, {
    title: title,
    subtitle: subtitle,
    massiveActions: massiveActions
  }), /*#__PURE__*/React__default.createElement(Table, {
    "aria-label": "collapsible table"
  }, /*#__PURE__*/React__default.createElement(TableHead, null, /*#__PURE__*/React__default.createElement(TableRow, null, /*#__PURE__*/React__default.createElement(TableCell, null, /*#__PURE__*/React__default.createElement(IconButton, {
    ...
    align: "center"
  }, t('actionsLabel')))), /*#__PURE__*/React__default.createElement(TableBody, null, !!frontPagination ? rowsData.slice(pageNo * pageSize, pageNo * pageSize + pageSize) : rowsData.map(function (row, rowIndex) {
    return /*#__PURE__*/React__default.createElement(RowLoop, {
      key: Math.random(),
      index: Math.random(),
      row: row,
      columnsData: columnsData,
      collapsibleComponent: /*#__PURE__*/React__default.createElement(CollapsibleComponent, {
        row: row,
        indexRow: rowIndex
      }),
      actionsButtons: actionsButtons,
      actionsByRow: /*#__PURE__*/React__default.createElement(ActionComponent, {
        row: row,
        indexRow: rowIndex
      })
    });
...
var RowLoop = function RowLoop(props) {
  var row = props.row,
      collapsibleComponent = props.collapsibleComponent,
      columnsData = props.columnsData,
      actionsButtons = props.actionsButtons,
      actionsByRow = props.actionsByRow;
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(TableRow, null, /*#__PURE__*/React__default.createElement(TableCell, null, /*#__PURE__*/React__default.createElement(IconButton, {
    "aria-label": "expand row",
    size: "small",
    onClick: function onClick() {
      return setOpen(!open);
    }
  }, open ? /*#__PURE__*/React__default.createElement(KeyboardArrowUpIcon, null) : /*#__PURE__*/React__default.createElement(KeyboardArrowDownIcon, null))), columnsData.map(function (_ref3, indexRow) {
    var label = _ref3.label,
        _ref3$valueFixed = _ref3.valueFixed,
        valueFixed = _ref3$valueFixed === void 0 ? null : _ref3$valueFixed,
        _ref3$translationsLab = _ref3.translationsLabel,
        translationsLabel = _ref3$translationsLab === void 0 ? null : _ref3$translationsLab;
    var translation = !!translationsLabel ? t(translationsLabel["" + row[label]]) : '';
    return /*#__PURE__*/React__default.createElement(TableCell, {
      key: row[indexRow] + "-" + label,
      align: "center"
    ...
    align: "center"
  }, actionsByRow)), /*#__PURE__*/React__default.createElement(TableRow, null, /*#__PURE__*/React__default.createElement(TableCell, {
    style: {
      paddingBottom: 0,
      paddingTop: 0
    },
...
CollapsibleTable.defaultProps = {
  CollapsibleComponent: function CollapsibleComponent() {}
};
...
var CustomErrorDialog = function CustomErrorDialog(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement(core.Dialog, {
    ...
    className: "CustomErrorDialog__Header"
  }, /*#__PURE__*/React__default.createElement(core.Typography, {
    variant: "overline"
  }, /*#__PURE__*/React__default.createElement("span", null, header))), /*#__PURE__*/React__default.createElement(core.DialogTitle, {
    className: "CustomErrorDialog__Title"
  }, /*#__PURE__*/React__default.createElement(core.Typography, {
    variant: "button"
  }, /*#__PURE__*/React__default.createElement("span", null, title))), /*#__PURE__*/React__default.createElement(core.DialogContent, {
    className: "CustomErrorDialog__Content"
  }, /*#__PURE__*/React__default.createElement(core.DialogContentText, {
    component: 'div',
    className: "CustomErrorDialog__Content__Text"
  }, message))), /*#__PURE__*/React__default.createElement(core.Grid, {
    key: 1,
    item: true,
    xs: 5
  }, /*#__PURE__*/React__default.createElement(core.DialogContent, null, /*#__PURE__*/React__default.createElement("img", {
...
var EmptyState = function EmptyState(_ref) {
  ...
  }, /*#__PURE__*/React__default.createElement("h2", null, title), /*#__PURE__*/React__default.createElement("p", null, subtitle), /*#__PURE__*/React__default.createElement("img", {
...
var MultiCheckableCollapsibleTable = function MultiCheckableCollapsibleTable(_ref) {
  var title = _ref.title,
      subtitle = _ref.subtitle,
      massiveActions = _ref.massiveActions,
      rowsData = _ref.rowsData,
  ...
  var EnhancedTableHead = function EnhancedTableHead(props) {
    var onSelectAllClick = props.onSelectAllClick,
        numSelected = props.numSelected,
        rowCount = props.rowCount;
    return /*#__PURE__*/React__default.createElement(TableHead, null, /*#__PURE__*/React__default.createElement(TableRow, null, /*#__PURE__*/React__default.createElement(TableCell, null), /*#__PURE__*/React__default.createElement(TableCell, {
      padding: "checkbox"
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(TableContainer, {
    component: Paper
  }, /*#__PURE__*/React__default.createElement(EnhancedTableToolbar, {
    title: title,
    subtitle: subtitle,
    massiveActions: massiveActions,
    numSelected: selected.idsSelected.length,
    ...
    rowCount: rowsData.length
  }), /*#__PURE__*/React__default.createElement(TableBody, null, !!frontPagination ? rowsData.slice(pageNo * pageSize, pageNo * pageSize + pageSize) : rowsData.map(function (row, rowIndex) {
    var isItemSelected = isSelected(row.id ? row.id : row[Object.keys(row)[0]]);
    return /*#__PURE__*/React__default.createElement(RowLoop$1, {
      key: Math.random(),
      index: Math.random(),
      row: row,
      columnsData: columnsData,
...
var RowLoop$1 = function RowLoop(props) {
  var row = props.row,
      collapsibleComponent = props.collapsibleComponent,
      columnsData = props.columnsData,
      actionsButtons = props.actionsButtons,
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(TableRow, null, /*#__PURE__*/React__default.createElement(TableCell, null, /*#__PURE__*/React__default.createElement(IconButton, {
  ...
  }, open ? /*#__PURE__*/React__default.createElement(KeyboardArrowUpIcon, null) : /*#__PURE__*/React__default.createElement(KeyboardArrowDownIcon, null))), /*#__PURE__*/React__default.createElement(TableCell, {
    padding: "checkbox",
    onClick: function onClick() {
      return actionEvent();
    }
    ...
    checked: selected
  })), columnsData.map(function (_ref3, indexRow) {
    var label = _ref3.label,
        _ref3$valueFixed = _ref3.valueFixed,
        valueFixed = _ref3$valueFixed === void 0 ? null : _ref3$valueFixed,
        _ref3$translationsLab = _ref3.translationsLabel,
...
var SimpleTableType = function SimpleTableType(_ref) {
  var title = _ref.title,
      subtitle = _ref.subtitle,
      massiveActions = _ref.massiveActions,
      rowsData = _ref.rowsData,
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(core.TableContainer, null, /*#__PURE__*/React__default.createElement(EnhancedTableToolbar, {
    title: title,
    subtitle: subtitle,
    massiveActions: massiveActions,
    onDragNDropConfirm: onDragNDropConfirm,
    ...
    onDragEnd: onDragEnd
  }, /*#__PURE__*/React__default.createElement(core.Table, null, /*#__PURE__*/React__default.createElement(core.TableHead, null, /*#__PURE__*/React__default.createElement(core.TableRow, null, !!isDragNDrop && /*#__PURE__*/React__default.createElement(core.TableCell, {
    className: "CustomTable__Cell__DraggingIndicator",
    align: "center"
  }), columnsData.map(function (_ref3, indexCol) {
    var headerName = _ref3.headerName;
    return /*#__PURE__*/React__default.createElement(core.TableCell, {
      key: "header-" + indexCol
    }, t(headerName));
  }), !!actionsButtons && /*#__PURE__*/React__default.createElement(core.TableCell, {
    align: "center"
  }, t('actionsLabel')))), /*#__PURE__*/React__default.createElement(ConnectedDroppable, {
    droppableId: "custom-table-body-id"
  }, function (provided) {
    return /*#__PURE__*/React__default.createElement(core.TableBody, _extends({}, provided.droppableProps, {
      ref: provided.innerRef
    }), !!frontPagination ? rowsData.slice(pageNo * pageSize, pageNo * pageSize + pageSize) : rowsData.map(function (row, indexRow) {
      return /*#__PURE__*/React__default.createElement(PublicDraggable, {
        ...
        return /*#__PURE__*/React__default.createElement(core.TableRow, _extends({
          key: "" + row + indexRow + "-" + Math.random(),
          innerRef: provided.innerRef
        }, provided.draggableProps, provided.dragHandleProps), !!isDragNDrop && /*#__PURE__*/React__default.createElement(core.TableCell, {
          className: "CustomTable__Cell__DraggingIndicator",
          align: "center"
        }, /*#__PURE__*/React__default.createElement(DragNDropIcon, null)), columnsData.map(function (_ref4) {
          var label = _ref4.label,
              _ref4$valueFixed = _ref4.valueFixed,
              valueFixed = _ref4$valueFixed === void 0 ? null : _ref4$valueFixed,
              _ref4$translationsLab = _ref4.translationsLabel,
...
var CustomeTable = function CustomeTable(_ref) {
  var title = _ref.title,
      subtitle = _ref.subtitle,
      massiveActions = _ref.massiveActions,
      type = _ref.type,
      ...
      errorSubtitle = _ref.errorSubtitle,
      isLoading = _ref.isLoading,
      rowsData = _ref.rowsData,
      columnsData = _ref.columnsData,
      error = _ref.error,
      ...
      onChangePage = _ref.onChangePage,
      onChangeSizePage = _ref.onChangeSizePage,
      actionsByRow = _ref.actionsByRow,
      actionsButtons = _ref.actionsButtons,
      checkable = _ref.checkable,
      massiveActionOnSelect = _ref.massiveActionOnSelect,
      isDragNDrop = _ref.isDragNDrop,
      onDragNDrop = _ref.onDragNDrop,
      onDragNDropCancel = _ref.onDragNDropCancel,
      onDragNDropConfirm = _ref.onDragNDropConfirm,
      collapsibleComponent = _ref.collapsibleComponent,
      massiveActionOnSelectClick = _ref.massiveActionOnSelectClick,
      frontPagination = _ref.frontPagination;
  var errorData = errors[statusCode];
  ...
  if (!!error) {
    return /*#__PURE__*/React__default.createElement(CustomErrorDialog, {
      open: true,
      fullpage: false,
    ...
    if (!rowsData || !rowsData.length) {
      ...
      switch (type) {
        case 'collapsible':
          ...
          return /*#__PURE__*/React__default.createElement(CollapsibleTable, collapsibleProps);

        case 'multi-collapsible':
          var multiCollapsibleProps = {
            title: title,
            subtitle: subtitle,
            emptyTitle: emptyTitle,
            emptySubtitle: emptySubtitle,
          ...
          return /*#__PURE__*/React__default.createElement(MultiCheckableCollapsibleTable, multiCollapsibleProps);
        ...
        default:
          ...
          return !!checkable ? /*#__PURE__*/React__default.createElement(SimpleCheckableTable, simpleProps) : /*#__PURE__*/React__default.createElement(SimpleTableType, simpleProps);
      }
    }
  }
};
CustomeTable.propTypes = {
  ...
  statusCode: propTypes.error === true ? propTypes.number.isRequired : propTypes.number,
  ...
  onDragNDrop: propTypes.isDragNDrop === true ? propTypes.func.isRequired : propTypes.func,
  onDragNDropCancel: propTypes.isDragNDrop === true ? propTypes.func.isRequired : propTypes.func,
  onDragNDropConfirm: propTypes.isDragNDrop === true ? propTypes.func.isRequired : propTypes.func,
...
exports.CustomeTable = CustomeTable;
